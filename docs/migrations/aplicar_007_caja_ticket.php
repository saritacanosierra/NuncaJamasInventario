<?php
/**
 * Agrega IVA, domicilio y empaque al ticket de venta.
 * Uso: php docs/migrations/aplicar_007_caja_ticket.php
 */
...
$ya->execute([':version' => '007_caja_ticket']);
if ($ya->fetch()) {
    echo "007_caja_ticket ya estaba aplicada\n";
    exit(0);
}

$sql = file_get_contents(__DIR__ . '/007_caja_ticket.sql');
...
$marca->execute([':version' => '007_caja_ticket']);
echo "007_caja_ticket aplicada\n";
