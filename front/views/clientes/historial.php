...
<div class="main-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2><i class="bi bi-clock-history"></i> Historial de Compras<?php $ayuda = 'Compras de este cliente y lo que aún debe a fiado.'; require BASE_DIR . '/front/views/components/ayuda.php'; ?></h2>
